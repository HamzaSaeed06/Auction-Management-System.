                    ...
                    <TableBody>
                      {paginated.map((team, index) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <div className="text-sm font-medium text-slate-600 leading-tight truncate max-w-[150px]">{team.username || "—"}</div>
                            <div className="text-[11px] text-slate-400 mt-0.5 truncate max-w-[150px]">{team.email || "—"}</div>
                          </TableCell>
                          <TableCell>
                            <div className="flex items-center gap-3">
                                <div className={cn("h-8 w-8 shrink-0 rounded-full flex items-center justify-center text-[10px] font-bold border border-slate-200 overflow-hidden", !team.owner_image_url && "bg-slate-100 text-slate-600")}>
                                   {team.owner_image_url ? (
                                      <img src={team.owner_image_url.startsWith('http') ? team.owner_image_url : `/uploads/${team.owner_image_url}`} className="w-full h-full object-contain" alt="" />
                          ...
                          <TableCell>
                            <div className="text-sm font-bold text-slate-900 whitespace-nowrap">{formatCurrency(team.total_budget)}</div>
                          </TableCell>
                          <TableCell>
                            <div className="text-sm font-bold text-slate-950 whitespace-nowrap">{formatCurrency(team.remaining_budget)}</div>
                          </TableCell>
                           ...
                           <div>
                              ...
                              <div className="flex items-center gap-2">
                                 ...
                                 <div className="flex flex-col">
                                    <span className="text-xs font-bold text-slate-900 leading-none mb-0.5">{team.owner_name || "—"}</span>
                                    <span className="text-[10px] text-slate-400 font-medium truncate max-w-[100px]">{team.username || "No user"}</span>
                                 </div>
                              </div>
                           </div>
