                    ...
                    <TableBody>
                      {paginated.map((item) => (
                        <TableRow key={item.player_id}>
                          ...
                          <TableCell className="font-bold text-slate-900 whitespace-nowrap">{formatCurrency(item.base_price)}</TableCell>
                          <TableCell>
                            <span className={cn(
                              ...
                              item.status === "processed" ? "bg-slate-50 text-slate-500 border-slate-100" : 
                              "bg-emerald-50 text-emerald-700 border-emerald-100"
                            )}>
                              {item.status === "active" ? <Clock size={12} weight="bold" /> : item.status === "processed" ? <Prohibit size={12} weight="bold" /> : <CheckCircle size={12} weight="bold" />}
                              {item.status}
                            </span>
                          </TableCell>
                          <TableCell>
                      ...
                      <div key={item.pool_id} className="surface group hover:border-slate-900 transition-all duration-300 bg-white">
                        <div className="p-4">
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <span className="text-[9px] font-bold text-slate-300">#{item.lot_number}</span>
                          </div>
