                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex items-center gap-3">
                             ...
                             <div className="text-ui-semibold text-slate-950 truncate max-w-[150px]">{player.name}</div>
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell className="text-slate-500">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-ui truncate max-w-[80px]">{player.country_name || "-"}</span>
                          </div>
                        </TableCell>
                        <TableCell className="text-slate-500 capitalize">{player.category_name || "-"}</TableCell>
                        <TableCell className="font-bold text-slate-900 whitespace-nowrap">{formatCurrency(player.base_price)}</TableCell>
                        <TableCell>
                    ...
                    >
                       <div className="p-4">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="flex items-center gap-1.5">
                                 ...
                                 <RoleBadge role={player.role} className="scale-90 origin-left" />
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="mt-3 flex items-center justify-between">
                           <div className="flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest bg-slate-50">
                              <div className={cn("h-1 w-1 rounded-full", 
                                player.status === "sold" ? "bg-emerald-500" : 
                                player.status === "withdrawn" ? "bg-red-500" : 
                                "bg-slate-300"
                              )} />
                              <span className="capitalize">{player.status || "unsold"}</span>
                           </div>
