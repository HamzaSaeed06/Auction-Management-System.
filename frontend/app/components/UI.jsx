...
export const Table = React.forwardRef(({ className, ...props }, ref) => (
  <div className="w-full overflow-x-auto relative border-t border-slate-100 no-scrollbar custom-scrollbar">
    <table ref={ref} className={cn("w-full border-collapse text-left min-w-[600px] lg:min-w-0", className)} {...props} />
  </div>
))
...
export const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th ref={ref} className={cn("h-12 px-4 text-left align-middle text-sub text-slate-900 whitespace-nowrap", className)} {...props} />
))
      ...
      {open ? (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{ maxWidth: `min(calc(100vw - 32px), ${width}px)` }}
          >
