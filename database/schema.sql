-- ============================================================
-- CRICKET AUCTION MANAGEMENT SYSTEM (Auction OS)
-- Comprehensive SQL Schema & Seed Data
-- ============================================================
...
CREATE TABLE Players (
    ...
    action_image_url VARCHAR(500) NULL,
...
CREATE TABLE Teams (
    ...
    owner_image_url VARCHAR(500) NULL,
...
-- ============================================================
-- 6. SEED DATA
-- Default password for accounts: admin123
-- ============================================================
...
INSERT INTO Player_Category (category_name, base_price, min_price, max_price) VALUES
('Platinum', 20000000, 15000000, 50000000),
('Diamond', 15000000, 10000000, 30000000),
('Gold', 10000000, 5000000, 20000000),
('Silver', 5000000, 2000000, 10000000);

INSERT INTO Countries (country_name, region, country_code) VALUES
('Pakistan', 'Asia', 'PK'),
('India', 'Asia', 'IN'),
('Australia', 'Oceania', 'AU'),
('England', 'Europe', 'GB'),
('South Africa', 'Africa', 'ZA'),
('West Indies', 'Caribbean', 'WI'),
('New Zealand', 'Oceania', 'NZ'),
('Afghanistan', 'Asia', 'AF');

INSERT INTO Auction (auction_name, season, auction_date, venue, location, total_budget_per_team, status) VALUES
('Auction OS Championship', 2026, '2026-06-01', 'Gaddafi Stadium', 'Lahore', 95000000, 'upcoming');
